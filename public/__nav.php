<div class="bg-tarnsparent">
    <!--Desktop-->
    <nav class="flex justify-between p-6 px-4 container mx-auto" data-config-target=".navbar-menu" data-config-class="hidden">
        <div class="flex justify-between items-center w-full">
            <div class="w-1/3 xl:w-1/4">
                <a class="block max-w-max flex items-center flex-no-shrink" href="#">
                    <img class="h-16" src="img/logo.webp"><!--todo logo in vector-->
                    <span class="font-semibold text-xl tracking-tight">М А Н Э Б</span>
                </a>
            </div>
            <div class="w-1/2 xl:w-1/2">
                <ul class="hidden xl:flex xl:justify-center">
                    <li class="mr-10"><a class="text-gray-500 hover:text-gray-900 font-medium" href="#">Проекты</a></li>
                    <li class="mr-10"><a class="text-gray-500 hover:text-gray-900 font-medium" href="#">Мероприятия</a></li>
                    <li class="mr-10"><a class="text-gray-500 hover:text-gray-900 font-medium" href="#">Команда</a></li>
                    <li class="mr-10"><a class="text-gray-500 hover:text-gray-900 font-medium" href="#">Контакты</a></li>
                    <li class="mr-10"><a class="text-gray-500 hover:text-gray-900 font-medium" href="#">Как помочь?</a></li>
                </ul>
            </div>
            <div class="w-1/3 xl:w-1/4">
                <div class="hidden xl:flex items-center justify-end">
                    <a class="inline-block py-2 px-4 text-sm leading-5 text-yellow-50 hover:bg-yellow-600 font-medium focus:ring-2 focus:ring-yellow-500 focus:ring-opacity-50 rounded-md bg-yellow-500" href="#">Eng</a>
                    <a class="inline-block py-2 px-4 mr-2 leading-5 text-gray-500 hover:text-gray-900 bg-transparent font-medium rounded-md" href="#">Deu</a>
                </div>
            ...
            <nav class="relative p-6 h-full overflow-y-auto">
                <div class="flex flex-col justify-between h-full">
                    ...
                    <ul class="py-6">
                        ...
                        <li><a class="block py-3 px-4 text-gray-500 hover:text-gray-900 font-medium hover:bg-gray-50 rounded-md" href="#">Как нам помочь?</a></li>
                    </ul>
